...
export const ReactLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 256 228" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
export const TypeScriptLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M20 20h216v216H20V20zm99.617 149.686c0 13.758 7.93 24.234 23.734 24.234 10.281 0 17.305-5.156 20.625-12.11l11.25 6.797c-5.508 9.727-15.43 16.875-31.875 16.875-20.625 0-36.328-10.664-36.328-35.156V97.5h13.594v72.186zm51.094-72.186h13.594v13.594h-13.594V97.5zm0 21.094h13.594v72.187h-13.594V118.594z"
      fill="white"
    />
  </svg>
)
...
export const OpenAILogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="128" cy="128" r="64" fill="white" opacity="0.2" />
    <circle cx="128" cy="128" r="48" fill="white" opacity="0.3" />
    <circle cx="128" cy="128" r="32" fill="white" opacity="0.5" />
...
export const N8nLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="256" height="256" rx="60" fill="#EA4B71" />
    <rect x="80" y="80" width="40" height="96" rx="8" fill="white" />
    <rect x="136" y="80" width="40" height="96" rx="8" fill="white" />
  </svg>
)
